...
public class UserDao extends BaseDao {
    ...
    public void addUser(User user) {
        String sql = "INSERT INTO users(email, passwd,full_name,isInst) VALUES(?,?,?,?)";

        this.jdbcTemplate.update(sql, user.email, Security.md5(user.passwd),user.full_name,user.isInst);
    }
