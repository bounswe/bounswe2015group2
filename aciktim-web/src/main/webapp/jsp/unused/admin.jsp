...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        <a class="btn btn-primary btn-sm" href="${contextPath}/admin/user/new">New User</a>
        <table class="table table-bordered" style="margin-top:10px;">
            ...
            <c:forEach var="user" items="${users}" varStatus="roop">
                <tr>
                    ...
                    <td>${user.email}</td>
                    <td>${user.passwd}</td>
                    <td><a class="btn btn-primary btn-sm" href="${contextPath}/admin/user/edit?id=${user.id}">Edit</a></td>
                    <td><a class="btn btn-danger btn-sm" href="${contextPath}/admin/user/delete?id=${user.id}">Delete</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
